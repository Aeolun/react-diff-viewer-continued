...
export const defaultLightThemeVariables: Required<ReactDiffViewerStylesVariables> =
  {
...
export const defaultDarkThemeVariables: Required<ReactDiffViewerStylesVariables> =
  {
